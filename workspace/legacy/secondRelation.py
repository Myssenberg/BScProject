...
lv = lvs = order.random() #lv and lvs instatiated as the same here to make the proof run
...
reEnc1 = re_enc(g, order, pk_T, (c0_v, c1_v), r_v.value)
...
#Proof
stmt = reenc_stmt1 & dec_stmt & reenc_stmt2 & reenc_stmt3
